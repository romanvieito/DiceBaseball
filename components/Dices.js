        ...
        <div>
          <div className={`dices ${className}`}>
            <div className="first-dice" onClick={ onClickDices } style={{ cursor: "pointer" }}>
              ...
              {valueDice1 === 2 ? (
                <NormalImg src={DiceImg2} alt={valueDice1.toString()} />
              ) : null}
              {valueDice1 === 3 ? (
                <NormalImg src={DiceImg3} alt={valueDice1.toString()} />
              ) : null}
              {valueDice1 === 4 ? (
                <NormalImg src={DiceImg4} alt={valueDice1.toString()} />
              ) : null}
              {valueDice1 === 5 ? (
                <NormalImg src={DiceImg5} alt={valueDice1.toString()} />
              ) : null}
              {valueDice1 === 6 ? (
            ...
            <div className="second-dice ml-1" onClick={ onClickDices } style={{ cursor: "pointer" }}>
              ...
              {valueDice2 === 2 ? (
                <NormalImg src={DiceImg2} alt={valueDice2.toString()} />
              ) : null}
              {valueDice2 === 3 ? (
                <NormalImg src={DiceImg3} alt={valueDice2.toString()} />
              ) : null}
              {valueDice2 === 4 ? (
                <NormalImg src={DiceImg4} alt={valueDice2.toString()} />
              ) : null}
              {valueDice2 === 5 ? (
                <NormalImg src={DiceImg5} alt={valueDice2.toString()} />
              ) : null}
              {valueDice2 === 6 ? (
                <NormalImg src={DiceImg6} alt={valueDice2.toString()} />
              ) : null}
            </div>
            <style jsx>{`
              .dices {
